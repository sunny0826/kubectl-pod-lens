...
|            |                                          | TargetPort:http                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-compact                           | ClusterIP:100.65.165.163              |
+            +                                          +---------------------------------------+
|            |                                          | Name:http                             |
|            |                                          | Port:10902                            |
|            |                                          | TargetPort:http                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-query-grpc                        | Name:grpc                             |
|            |                                          | Port:10901                            |
|            |                                          | TargetPort:grpc                       |
+            +------------------------------------------+---------------------------------------+
...
|            |                                          | TargetPort:http                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-sidecar-grpc                      | Name:grpc                             |
|            |                                          | Port:10901                            |
|            |                                          | TargetPort:grpc                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-sidecar-http                      | ClusterIP:100.64.94.33                |
+            +                                          +---------------------------------------+
|            |                                          | Name:http                             |
|            |                                          | Port:10902                            |
|            |                                          | TargetPort:http                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-store-grpc                        | Name:grpc                             |
|            |                                          | Port:10901                            |
|            |                                          | TargetPort:grpc                       |
+            +------------------------------------------+---------------------------------------+
|            | thanos-store-http                        | ClusterIP:100.68.88.86                |
+            +                                          +---------------------------------------+
|            |                                          | Name:http                             |
|            |                                          | Port:10902                            |
|            |                                          | TargetPort:http                       |
